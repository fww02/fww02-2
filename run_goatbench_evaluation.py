...
def main(cfg, start_ratio=0.0, end_ratio=1.0, split=0):
    ...
    for scene_data_file in scene_data_list:
        ...
        for episode_idx, episode in enumerate(scene_data["episodes"]):
            ...
            question_id = f"{scene_id}_{episode_id}"  # reuse AEQA-style naming for logger/outputs
