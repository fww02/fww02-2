...
class ConflictResolver:
    ...
    def resolve(
        ...
        3. If conflict detected:
           ...
           d. If comparable but irreconcilable -> SPLIT
              NOTE: "SPLIT" here is a *detection-only* label meaning the conflict
              is unresolvable. The caller must NOT physically create a new object;
              it should treat this as KEEP and log the conflict for visualization.
        4. For SPLIT: register SYMMETRIC mutual exclusion to prevent future re-merging.
